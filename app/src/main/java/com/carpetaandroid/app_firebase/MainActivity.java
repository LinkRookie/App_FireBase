...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnbuscar,btnmodificar,btneliminar,btnregistrar;
    ListView lvDatos;
        ...
        btnbuscar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Toast.makeText(MainActivity.this,"No c pudo realizar la accion Buscar... reiniciando",Toast.LENGTH_LONG).show();
        ...
        btnregistrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Toast.makeText(MainActivity.this,"No c pudo realizar la accion registrar... reiniciando",Toast.LENGTH_LONG).show();
                    Intent i = getBaseContext().getPackageManager()
                            .getLaunchIntentForPackage( getBaseContext().getPackageName() );
                    i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(i);
        ...
        btneliminar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Toast.makeText(MainActivity.this,"No c pudo realizar la accion Eliminar... reiniciando",Toast.LENGTH_LONG).show();
                    Intent i = getBaseContext().getPackageManager()
                            .getLaunchIntentForPackage( getBaseContext().getPackageName() );
                    i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(i);
        ...
        btnmodificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Toast.makeText(MainActivity.this,"No c pudo realizar la accion Modificar... reiniciando",Toast.LENGTH_LONG).show();
                    Intent i = getBaseContext().getPackageManager()
                            .getLaunchIntentForPackage( getBaseContext().getPackageName() );
                    i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(i);
